		...
		<el-card>
			...
			<el-row :gutter="20">
				...
				<el-col :span="12" class="colPadding">
					期望发货日期：
					<div>
						<el-date-picker v-model="deliveryTime" align="right" type="date" placeholder="选择期望发货日期" :picker-options="pickerOptions"> </el-date-picker>
					</div>
				</el-col>
				<!-- 》》》》》》收货场景《《《《《《《《《 -->
				<el-col :span="12" class="colPadding">
				...
				<!-- 》》》》》》备注《《《《《《《《《《《 -->
				<el-col :span="12" class="colPadding">
					<el-input type="textarea" placeholder="请输入备注信息（不超200字）" v-model="textarea" maxlength="200" show-word-limit > </el-input>
				</el-col>
			</el-row>
		</div>	
		</el-card>
