			...
			<div class="productLine">
				...
				<el-row class="row">
					<el-table :data="productLine" border style="width: 100%">
						...
						<el-table-column prop="specification" label="合同产品名称" ></el-table-column>
						<el-table-column prop="specification" label="规格" ></el-table-column>
						<el-table-column prop="unit" label="单位" ></el-table-column>
						<el-table-column prop="unit" label="单价(元)" ></el-table-column>
						<el-table-column prop="applicationNum" label="数量" ></el-table-column>
						<el-table-column prop="applicationNum" label="金额小计(元)" ></el-table-column>
