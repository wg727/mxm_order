...
<!-- =============================================================================================== -->
		...
		<el-dialog v-model="addDialogVisible" title="选择产品" width="50%" :before-close="handleClose" >
			<el-row :gutter="10">
				<el-col :span="7">
						<el-input placeholder="请输入产品名称" @clear="getGoofsList" clearable v-model="addProductInfo.query"></el-input>
						<el-button  icon="el-icon-search" @click="getGoofsList"></el-button>
						<el-input placeholder="请输入内容" prefix-icon="el-icon-search" v-model="addProductInfo.query" clearable></el-input>
				</el-col>
			</el-row>
    <template #footer>
