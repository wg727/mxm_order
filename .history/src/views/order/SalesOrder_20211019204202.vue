    ...
    <el-card>
      ...
      <el-row class="orderlist"> 
					<el-table :data="goodsList" border >
						...
						<el-table-column prop="organization" label="下单时间"></el-table-column>
						<el-table-column prop="transferred" label="客户" ></el-table-column>
						<el-table-column prop="sourceType" label="所属区域" ></el-table-column>
						<el-table-column prop="applications" label="订单金额(元)" ></el-table-column>
						<el-table-column prop="approvalsNum" label="待发数量/订单数量" ></el-table-column>
						<el-table-column prop="sentNum" label="已发数量/已申请数量" ></el-table-column>
						<el-table-column prop="cancelNum" label="订单状态" ></el-table-column>
						<el-table-column prop="cancellationsNum" label="收款状态" ></el-table-column>
						<el-table-column prop="state" label="钉钉审批" ></el-table-column>
						<el-table-column prop="applicant" label="审核人" ></el-table-column>
						<el-table-column prop="planner" label="期望交货日期" ></el-table-column>
