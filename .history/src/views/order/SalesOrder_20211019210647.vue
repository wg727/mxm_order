    ...
    <el-card>
      ...
      <el-row class="row">
        <el-table :data="orderList" border style="width: 100%">
          ...
          <el-table-column width="300" prop="orderNum" label="订单总数"></el-table-column>
          <el-table-column width="300" prop="deliver" label="待发货" ></el-table-column>
          <el-table-column width="300" prop="shipped" label="已发货" ></el-table-column>
          <el-table-column width="300" prop="received" label="已收货" ></el-table-column>
        </el-table>
      </el-row>
