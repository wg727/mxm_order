      ...
      <div class="button">
		...
		<el-card>
			...
			<el-row :gutter="20">
				...
				<el-col :span="12">
						收货人:<el-input placeholder="云镖网络科技有限公司" v-model="transOrganiza" :disabled="true"></el-input>
				</el-col>
				<el-col :span="12">
						收货电话:<el-input placeholder="云镖网络科技有限公司" v-model="transOrganiza" :disabled="true"></el-input>
				</el-col>
			</el-row>
		</div>	
		</el-card>
