<template>
    <div>
        ...
        <el-card>
            ...
            <el-row :gutter="10">
                <el-col :span="5">
                    <el-input placeholder="请输入产品名称" @clear="getProductList" clearable v-model="queryInfo.productName"></el-input>
            ...
            <el-row class="row">
                <el-table :data="proList" border style="width: 100%">
                    ...
                    <el-table-column prop="auditNumCount" label="审批数量"></el-table-column>
