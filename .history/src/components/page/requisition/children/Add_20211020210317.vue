<template>
	...
	<el-form >
		<el-form-item label="资产所属组织"><br>
			<el-select v-model="value" placeholder="请选择活动区域" style="width:300px">
				...
				<el-option label="区域二" value="beijing"></el-option>
					...
					<el-col :span="12">
							调入组织:<el-input placeholder="云镖网络科技有限公司" v-model="transOrganiza" :disabled="true" style="width:100px"></el-input>
					</el-col>
					<el-col :span="12">
