		...
		<el-card>
			...
			<div class="a">
				<el-row :gutter="20">
					...
					<el-col :span="12">
							资产所属组织:<br><br><el-select v-model="value" placeholder="请选择资产所属组织">
					...
					<el-col :span="12" class="colPadding">
							...
							<div>
								省市区:<el-cascader v-model="addInfo.city" :options="citys" @change="handleChange" placeholder="请选择省市区"></el-cascader>
							</div>
					</el-col>
					<el-col :span="12" class="colPadding">
