			...
			<div class="addProductVisible">
				...
				<el-row class="row">
					<el-table :data="dialogTableList" border style="width: 100%" header-cell-class-name="table-header" @selection-change="handleSelectionChange">
						...
						<el-table-column prop="specification" label="	省份-城市"></el-table-column>
						<el-table-column prop="unit" label="可用量" ></el-table-column>
						<el-table-column prop="unit" label="采购在途库存" ></el-table-column>
						<el-table-column prop="unit" label="调拨在途库存" ></el-table-column>
					</el-table>
				</el-row>
