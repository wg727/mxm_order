    ...
    <el-card>
      ...
      <el-row>
        <el-table :data="goodsList" border style="width: 100%">
          ...
          <el-table-column prop="planner" label="客户名称" ></el-table-column>
          <el-table-column prop="planner" label="客户地址" ></el-table-column>
          <el-table-column prop="planner" label="客户联系方式" ></el-table-column>
