            ...
            <div class="productLine">
                ...
                <el-row class="row">
                    <el-table :data="ItemList" border style="width: 100%">
                        ...
                        <el-table-column prop="ItemList.productName" label="产品名称"></el-table-column>
                        <el-table-column prop="ItemList.specification" label="规格"></el-table-column>
                        <el-table-column prop="ItemList.unit" label="单位"></el-table-column>
                        <el-table-column prop="ItemList.idleNum" label="闲置数量"></el-table-column>
                        <el-table-column label="申请数量">
                            <template v-slot="scoped">
                                <el-input type="number" placeholder="请输入数量" v-model="ItemList.applyNum">{{
                                    scoped.row
                                }}</el-input>
                            </template>
                        </el-table-column>
...
export default {
    ...
    methods: {
        ...
        getCity(){
            ...
            //     id:1
            // }
        	queryCity(this.cityMessage).then(res=>{
        ...
        getProducts() {
            if (this.addInfo.assetsOrgId === '') {
                ...
                productLists(this.products).then(res => {
                    ...
                    this.ItemList.productId=res.data.id
                    this.ItemList.productName=res.data.name
