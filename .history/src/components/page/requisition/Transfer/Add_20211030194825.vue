        ...
        <el-dialog title="产品列表" :visible.sync="addProductVisible" width="50%" :before-close="handleClose">
            <div class="addProductVisible">
                ...
                <el-row :gutter="10">
                    <el-col :span="7">
                        <el-input
                            placeholder="请输入产品名称"
                            clearable
                            v-model="requertProList.inputproductName"
                            class="search_input"
                        ></el-input>
                ...
                <el-pagination
                    ...
                    :current-page="requertProList.p"
                    @size-change="handleSizeChange"
                    :page-size="requertProList.s"
    ...
    methods: {
        ...
        getProducts() {
            if (this.addInfo.assetsOrgId === '') {
                ...
                this.requertProList[assetsOrgId]=this.addInfo.assetsOrgId;
                console.log(this.requertProList);
                productLists(newProducts).then(res => {
                    // console.log(res);
