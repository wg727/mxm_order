    ...
    <div>
        <el-card>
            <div class="transheader">
                ...
                <el-button size="small" icon="el-icon-plus" @click="exportList()" class="button"> 批量导出</el-button>
                ...
                <el-popover ref="popoverRef" placement="bottom-start" width="400" trigger="click">
                    ...
                    <el-button size="small" slot="reference" icon="el-icon-lx-filter" style="margin-left:10px" @click="visible = !visible">
                        筛选
                    </el-button>
                </el-popover>
            </div>
...
export default {
    ...
    data() {
        return {
            queryInfo: {
                applyCode: '', //调拨申请单号
                applyStatus: 0,//调拨申请状态 0-待审核 1待发货 2审核拒绝 3待收货 4已取消 5待完成
                applyType: 0,   //申请类型 0-手工新增 1-实施任务书
                applyUserName: 'string',   //申请人姓名
                auditName: 'string',   //审核人-计划员
                auditQuery: 0,   //是否审批列表- 非null -是(若传null为申请列表)
                createdDateEnd: 'string',   //筛选项-申请时间尾
                createdDateStart: 'string',   //筛选项-申请时间起
                dataScope: 0,   //数据查看权限
                fromCode: 'string',   //来源编号

                id: 0,   //调入组织id
                inOrgId: 0,   //调入组织id

                inOrgName: 'string',   //调入组织名称
                loginUserId: 0,   //当前登陆人用户id
                loginUserRoleOrgId: 0,   //当前登陆人角色所属组织id
                outOrgId: 0,   //调出组织id
                outOrgName: 'string',   //调出组织名称
                p: 0,   //页码
