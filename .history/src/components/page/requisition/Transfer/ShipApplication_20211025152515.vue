			...
			<div class="productLine">
				...
				<el-row class="row">
					<el-table :data="productLine" border style="width: 100%">
						...
						<el-table-column prop="applicationShipNum" label="申请发货数量" ></el-table-column>
					</el-table>
				</el-row>
			</div> 
		</el-card>
	...
	data(){
      ...
      value: '',
          ...
          children: [{
			...
			productLine: [
        {
          productName: '阿修罗',   //产品名称
          specification:'选择色系:颜色：蓝',         //规格
          unit: '	默认',              //单位
					idleNum:'	云镖网络科技有限公司',              //闲置数量
          applicationNum: 3,       //申请数量
          applicationShipNum: ''              //操作
        },
			],
