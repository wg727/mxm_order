    ...
    <div>
        ...
        <el-dialog title="产品列表" :visible.sync="addProductVisible" width="50%" :before-close="handleClose">
            <div class="addProductVisible">
                ...
                <el-row :gutter="10">
                    <el-col :span="7">
                        <el-input placeholder="请输入产品名称" clearable v-model="inputproductName" class="search_input"></el-input>
    ...
    methods: {
        ...
        getProducts() {
            ...
            productLists(requertProList).then(res => {
                ...
                this.addInfo.productName=res.data.productName;
                this.addInfo.productSpecId=res.data.productSpecId;
                this.addInfo.specUnionKey=res.data.specUnionKey;
                this.addInfo.unitText=res.data.unitText;
                this.addInfo.applyItemList=res.data.productId;
                this.addInfo.applyItemList=res.data.productId;
                this.addInfo.applyItemList=res.data.productId;
