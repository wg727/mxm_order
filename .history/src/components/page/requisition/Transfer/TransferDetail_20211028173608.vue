<template>
    <div>
        <div class="transferDetail">
            ...
            <div class="button">
                <el-button size="small" @click="gobackDetail">取消申请</el-button>
        ...
        <!-- ==========================q取消发货申请的对话框====================================== -->
        <el-dialog title="取消申请" :visible.sync="cancelApplyDialog" width="30%" :before-close="handleClose">
            <el-from :model="cancelApply"> 
                <el-form-item label="活动形式">
                    <el-input type="textarea" v-model="cancelApply.cancelText"></el-input>
                </el-form-item>
            </el-from>
