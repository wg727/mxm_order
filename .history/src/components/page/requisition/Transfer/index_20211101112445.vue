        ...
        <el-card>
                        ...
                        <el-form :model="filterInfo">
                            <el-row>
                                ...
                                <el-form-item label="来源类型:" class="filter_el-col">
                                    <el-select v-model="filterInfo.applyType" style="width:100%" :popper-append-to-body="false">
            ...
            <el-row class="orderlist">
                <el-table :data="goodsList" border>
                    <el-table-column prop="applyCode" label="单据号" width="150px" style="height:50px">
