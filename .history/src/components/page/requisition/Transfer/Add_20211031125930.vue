...
export default {
    ...
    methods: {
        ...
        addShipment() {
            ...
            let newApplyItemList = [];
            let outOrg = this.addInfo.assetsOrgId
            let auditNum = this.addInfo.applyItemList.applyNum
             this.addInfo.applyItemList.forEach(item => {
                 item.outOrgId=outOrg,
                 item.auditNum=auditNum

             });
            
            // this.applyItemList.map(item=>{
            //     newApplyItemList.push(
            //         Object.assign(item,{outOrgId:'this.addInfo.assetsOrgId'}),
            //         Object.assign(item,{auditNum:'this.addInfo.applyItemList.applyNum'})
            //     )
            // })
            console.log(this.addInfo.applyItemList);
            // this.addInfo.applyItemList=newApplyItemList
