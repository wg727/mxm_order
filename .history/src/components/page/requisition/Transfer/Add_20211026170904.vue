      ...
      <div class="button">
		...
		<span>发货单信息</span>
			<div class="invoice_info_div">
				<el-form :model="addInfo" ref="addMessageRef">
					<el-row>
						<el-col :span="11" >
		...
		<!------------------- 发货单列表-------------------- -->
			<div class="productLine">
				<span>发货单列表</span>
				<el-button size="small" @click="addProductVisible = true">提交</el-button>
				<el-row class="row">
					<el-table :data="submitInfo" border style="width: 100%">
						<el-table-column prop="transOrganiza" label="调入组织"></el-table-column>
						<el-table-column prop="assetsOrg" label="资产所属组织"></el-table-column>
						<el-table-column prop="receiver" label="收货人" ></el-table-column>
						<el-table-column prop="receivingPhone" label="收货电话" ></el-table-column>
						<el-table-column prop="city" label="城市" ></el-table-column>
						<el-table-column prop="address" label="详细地址" ></el-table-column>
						<el-table-column prop="deliveryTime" label="期望发货日期" ></el-table-column>
...
export default {
	...
	methods:{
		...
		// 添加发货信息
		addInfoMethod(){
			this.submitInfo.push(this.addInfo)
			this.$refs.addMessageRef.
