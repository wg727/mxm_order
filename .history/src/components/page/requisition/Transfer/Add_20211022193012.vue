      ...
      <div class="button">
		...
		<el-card>
			...
			<div class="productLine">
				...
				<el-row class="row">
					<el-table :data="productLine" border style="width: 100%" header-cell-class-name="table-header" @selection-change="handleSelectionChange">
		...
		<el-dialog
			...
			<div class="addProductVisible">
				...
				<el-row :gutter="10">
					<el-col :span="7">
							<el-input placeholder="请输入产品名称"  clearable v-model="addProductVisibleInfo.query"></el-input>
