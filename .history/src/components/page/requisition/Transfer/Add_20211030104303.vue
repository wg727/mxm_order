            ...
            <div class="productLine">
                ...
                <el-row class="row">
                    <el-table :data="item" border style="width: 100%">
                        <div v-for="item in addInfo.applyItemLis" :key="item.productId">
                            <el-table-column type="index" label="序列"></el-table-column>
                            <el-table-column :prop="item.productName" label="产品名称"></el-table-column>
                            <el-table-column :prop="item.specification" label="规格"></el-table-column>
                            <el-table-column :prop="item.unit" label="单位">台</el-table-column>
                            <el-table-column :prop="item.idleNum" label="闲置数量"></el-table-column>
                            <el-table-column label="申请数量">
                                <template v-slot="scoped">
                                    <el-input type="number" placeholder="请输入数量" v-model="item.applyNum">{{ scoped.row }}</el-input>
                                </template>
                            </el-table-column>
