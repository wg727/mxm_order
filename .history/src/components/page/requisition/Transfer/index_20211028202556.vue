        ...
        <el-card>
            <div class="transheader">
                ...
                <el-popover ref="popoverRef" placement="bottom-start" width="400" trigger="click">
                    <el-form :model="filterInfo" ref="resetFilters">
                        <el-row>
                            ...
                            <el-form-item label="设备序列号:" class="filter_el-col">
                                <el-input placeholder="输入设备序列号" v-model="filterInfo.ddeviseSerialNum"></el-input>
                            </el-form-item>
                            ...
                            <el-form-item label="来源类型:" class="filter_el-col">
                                <el-select
                                    v-model="filterInfo.fromCode"
                                    style="width:100%"
                                    :popper-append-to-body="false"
                                >
                                    <el-option label="全部" value=""></el-option>
                                    <el-option label="DMI调拨" value="1"></el-option>
                                    <el-option label="实施任务书" value="2"></el-option>
                                    <el-option label="回收申请" value="3"></el-option>
                                </el-select>
                            </el-form-item>
                            ...
                            <el-form-item class="besure">
                                <el-button type="info" @click="resetFilter('resetFilters')">重置</el-button>
...
export default {
    ...
    methods: {
        ...
        resetFilter(resetFilters){
            this.$refs[resetFilters].resetFields()
        }
    },
