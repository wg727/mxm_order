                            ...
                            <el-table-column label="申请数量" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'applyItemList[' + scope.$index + '].applyNum'">
                                        <el-input v-if="addInfo.applyItemList[0].productName===''" type="number" v-model="addInfo.applyItemList[scope.$index].applyNum" placeholder="请输入数量"></el-input>
                                    </el-form-item>
                                </template>
                            </el-table-column>
                            <el-table-column label="操作" width="80">
                ...
                applyItemList: [
                    {
                        ...
                        unitText: '', //单位
                        bathEnable: '', //是否启用批次管理（0否1是）
                        serialNumberEnable: '', //是否启用序列号管理（0否1是）
                        outOrgId: '' //调出组织
                    }
                ]
            },
    ...
    methods: {
        ...
        handleSelectionChange(val) {
            ...
            for (let i = 0; i < newVal.length; i++) {
                ...
                console.log(newVal[i].productId);
                console.log(newVal[i].productName);
