          ...
          <el-step title="已完成" />
			...
			<el-tabs type="border-card" style="margin-top:50px">
				...
				<el-tab-pane label="操作记录">
					<el-table :data="shipmentApplica" border >
						<el-table-column prop="index" label="操作时间"></el-table-column>
						<el-table-column prop="applicationNum" label="操作人" ></el-table-column>
						<el-table-column prop="shipNum" label="访问设备" ></el-table-column>
						<el-table-column prop="cancelNum" label="	访问城市" ></el-table-column>
						<el-table-column prop="state" label="ip地址" ></el-table-column>
						<el-table-column prop="applicationTime" label="操作内容" ></el-table-column>
					</el-table>
				</el-tab-pane>
			</el-tabs>
