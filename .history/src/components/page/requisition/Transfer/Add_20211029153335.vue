                        ...
                        <el-col :span="11" class="odd_lie">
                            <el-form-item label="资产所属组织：">
                                <el-select v-model="addInfo.assetsOrgId" placeholder="请选择资产所属组织" style="width: 100%" >
                                    <el-option v-for="item in assetOrgList" :key="item.assetsOrgId" :label="item.assetsOrgName" :value="item.assetsOrgId"></el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    ...
                    <el-row>
                        <el-col :span="11">
                            <el-form-item label="省市区："
                                ><br />
                                <el-cascader v-model="city" :options="cityList" placeholder="请选择省市区"  filterable clearable :props="city" change-on-select></el-cascader>
                            </el-form-item>
                        </el-col>
                        <el-col :span="11" class="odd_lie">
            ...
            <div class="productLine">
                ...
                <el-row class="row">
                    <el-table :data="multipleSelection" border style="width: 100%">
                        ...
                        <el-table-column prop="applicationNum" label="申请数量">
                            <template v-slot="scoped">
								<el-input type="number" placeholder="请输入数量" v-model="addInfo.applyItemList.applyNum">{{scoped.row}}</el-input>
							</template>
                        </el-table-column>
