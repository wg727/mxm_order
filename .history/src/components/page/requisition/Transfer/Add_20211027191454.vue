						...
						<el-col :span="11" class="odd_lie">
							<el-form-item label="资产所属组织：" >
								<el-select v-model="addInfo.assetsOrgId" placeholder="请选择资产所属组织" style="width:100%">
									<el-option label="中智永浩" value="1" ></el-option>
									<el-option label="深圳科卫" value="2"></el-option>
								</el-select>
							</el-form-item>
						</el-col>
					</el-row>
					...
					<el-row>
						<el-col :span="11" >
							<el-form-item label="省市区："><br>
								<el-cascader v-model="city" :options="citys"  placeholder="请选择省市区"></el-cascader> 
							</el-form-item>
						</el-col>
						<el-col :span="11" class="odd_lie">
					...
					<el-row>
						<el-col :span="11">
							<el-form-item  label="期望发货日期：" prop="name" ><br>
								<el-date-picker  style="width:100%" v-model="addInfo.expectDeliveryDate" type="date" placeholder="选择期望发货日期" value-format="yyyy-MM-dd HH:mm:ss"> </el-date-picker>
							</el-form-item>
						</el-col>
						<el-col :span="11" class="odd_lie">
...
import {addShipmentRequisition,queryTransferOrganization,queryCity,productLists} from '@/request/api.js' 
        ...
        this.$confirm('确认关闭？')
          ...
          .catch(_ => {});
			...
			getTransferOrganization(){
				queryTransferOrganization().then(res=>{
					this.addInfo.transOrganiza=res.data.orgName
			...
			//获取产品列表
			getProducts(){
				if(this.addInfo.assetsOrgId==='')alert('请输入组织')
