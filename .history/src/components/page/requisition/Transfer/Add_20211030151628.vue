                ...
                <div class="row">
                    ...
                    <el-form :model="AAA">
                        <el-table :data="AAA.aaa" border style="width: 100%">
                            <el-table-column type="index" label="序列"></el-table-column>
                            <el-table-column prop="id1" label="产品名称" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'aaa[' + scope.$index + '].id1'">
                                        <span class="table_list">{{ scope.row.id1 }}</span>
                                    </el-form-item>
                                </template>
                            </el-table-column>
                            <el-table-column prop="id2" label="规格" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'aaa[' + scope.$index + '].id2'">
                                        {{ scope.row.id2 }}
                                    </el-form-item>
                                </template>
                            </el-table-column>
                            <el-table-column prop="id2" label="单位" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'aaa[' + scope.$index + '].id2'">
                                        {{ scope.row.id2 }}
                                    </el-form-item>
                            ...
                            <el-table-column prop="id2" label="闲置数量" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'aaa[' + scope.$index + '].id2'">
                                        {{ scope.row.id2 }}
                                    </el-form-item>
                            ...
                            <el-table-column label="申请数量" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'aaa[' + scope.$index + '].id3'">
                                        <el-input type="number" v-model="AAA.aaa[scope.$index].id3" placeholder="请输入数量"></el-input>
                                    </el-form-item>
                                </template>
                            </el-table-column>
                            <el-table-column label="操作" width="80">
