            ...
            <div class="productLine">
                ...
                <div class="row">
                    ...
                    <el-form :model="producTableInfo">
                        <el-table :data="producTableInfo.producTableInfo" border style="width: 100%">
                            <el-table-column type="index" label="序列"></el-table-column>
                            <el-table-column prop="productName" label="产品名称" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'producTableInfo[' + scope.$index + '].productName'">
                            ...
                            <el-table-column prop="specUnionKey" label="规格" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'producTableInfo[' + scope.$index + '].specUnionKey'">
                            ...
                            <el-table-column prop="unitText" label="单位" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'producTableInfo[' + scope.$index + '].unitText'">
                                        {{ scope.row.unitText }}
                                    </el-form-item>
                                </template>
                            </el-table-column>
                            <el-table-column prop="idleQuantity" label="闲置数量" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'producTableInfo[' + scope.$index + '].idleQuantity'">
                            ...
                            <el-table-column label="申请数量" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'producTableInfo[' + scope.$index + '].applyNum'">
                                        <el-input
                                            type="number"
                                            v-model="producTableInfo.producTableInfo[scope.$index].applyNum"
                                            placeholder="请输入数量"
                                        ></el-input>
                                    </el-form-item>
                                </template>
    ...
    methods: {
        ...
        getProducts() {
            ...
            productLists(requertProList).then(res => {
                ...
                this.producTableInfo.producTableInfo.productName=res.data.productName;
                this.producTableInfo.producTableInfo.specUnionKey=res.data.specUnionKey;
                this.producTableInfo.producTableInfo.unitText=res.data.unitText;
