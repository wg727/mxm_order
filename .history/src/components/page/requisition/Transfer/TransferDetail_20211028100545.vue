            ...
            <div class="detail">
                ...
                <section class="detail_section1 detail_margin">
                    ...
                    <div class="section_list">
                        ...
                        <span>{{documentDetails.applyStatus}}</span>
    ...
    methods: {
        ...
        getTransferDetails() {
            ...
            transferApplicationDetails(params).then(res => {
							console.log(res);
							this.documentDetails.inOrgName=res.data.inOrgName;
							this.documentDetails.applyCode=res.data.applyCode;
							this.documentDetails.applyUserName=res.data.applyUserName;
							this.documentDetails.assetsOrgName=res.data.assetsOrgName;
							this.documentDetails.remark=res.data.remark;
							this.documentDetails.applyStatus=res.data.applyStatus;
							this.documentDetails.auditName=res.data.auditName;
							this.documentDetails.auditRemark=res.data.auditRemark;
							this.documentDetails.applyTypeText=res.data.applyTypeText;
							this.documentDetails.createdDate=res.data.createdDate;
							this.documentDetails.createdDate=res.data.lastUpdatedDate;
							this.documentDetails.receiverAddress=res.data.receiverAddress;
            });
        },
