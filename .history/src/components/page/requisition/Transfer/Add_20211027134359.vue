    ...
    <div>
        ...
        <el-card id="aaa">
            ...
            <div class="invoice_info_div">
                <el-form :model="addInfo" ref="loginFormRef">
                    <el-row>
                        <el-col :span="11">
                            <el-form-item label="调入组织：">
                                <el-input  v-model="addInfo.list.transOrganiza" :disabled="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="11" class="odd_lie">
                            <el-form-item label="资产所属组织：">
                                <el-select v-model="addInfo.list.assetsOrg" placeholder="请选择资产所属组织" style="width:100%">
                                    <el-option label="深圳科卫机器人科技有限公司" value="zhongzhi"></el-option>
                                    <el-option label="深圳中智永浩机器人有限公司" value="kewei"></el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                    </el-row>

                    <div v-for="(item, index) in addInfo.list" :key="index" class="receiver">
                        <el-button size="small" plain @click="addInfoMethod" class="addInfoMethod" type="danger" icon="el-icon-plus"
                            >追加发货申请
                        </el-button>
                        <el-row>
                            <el-col :span="11">
                                <el-form-item label="收货人：" prop="name">
                                    <el-input v-model="item.receiver" placeholder="请选择收货人"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="11" class="odd_lie">
                                <el-form-item label="收货电话：" prop="name">
                                    <el-input v-model="item.receivingPhone" placeholder="请输入收货电话"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                            <el-col :span="11">
                                <el-form-item label="省市区："
                                    ><br />
                                    <el-cascader v-model="item.city" :options="citys" placeholder="请选择省市区"></el-cascader>
                                </el-form-item>
                            </el-col>
                            <el-col :span="11" class="odd_lie">
                                <el-form-item label="详细地址：" prop="name">
                                    <el-input v-model="item.address" placeholder="请输入详细收货地址"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                            ...
                            <el-col :span="11" class="odd_lie">
                                <el-form-item label="收货场景：">
                                    <el-select v-model="item.receiptScenario" placeholder="请选择收货场景" style="width:100%">
                        ...
                        <div class="productLine">
                            ...
                            <el-row class="row">
                                <el-table :data="productLine" border style="width: 100%">
                                    ...
                                    <el-table-column prop="idleNum" label="闲置数量">
																			<el-input>1</el-input>
																		</el-table-column>
...
export default {
    ...
    data() {
        return {
            tempInfo: {
                transOrganiza: '深圳科卫机器人科技有限公司', //调入组织
                assetsOrg: '', //资产所属组织
                receiver: '', //收货人
                receivingPhone: '', //收货电话
                city: '', //城市
    ...
    methods: {
        ...
        // 添加发货信息
        addInfoMethod() {
            this.addInfo.list.push(JSON.parse(JSON.stringify(this.tempInfo)));
