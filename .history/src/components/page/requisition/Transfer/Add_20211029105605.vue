                    ...
                    <el-row>
                        ...
                        <el-col :span="11" class="odd_lie">
                            <el-form-item label="资产所属组织：">
                                <el-select v-model="addInfo.assetsOrgId" placeholder="请选择资产所属组织" style="width: 100%" v-for="item in assetOrgList" :key="item.assetsOrgId">
                                    <el-option :label='{{"item.assetsOrgName"s}}' value="1"></el-option>
...
import { addShipmentRequisition, queryTransferOrganization, queryCity, productLists, transferInOrganization,assetOrganization } from '@/request/api.js';
