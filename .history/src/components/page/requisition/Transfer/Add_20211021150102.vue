		...
		<el-card>
			...
			<div class="invoice_info_div">
				...
				<el-form :model="addInfo" :rules="rules">
					<el-row>
						...
						<el-col :span="11" class="odd_lie">
							<el-form-item label="资产所属组织:" >
								<el-select v-model="addInfo.assetsOrg" placeholder="请选择活动区域" style="width:100%">
					...
					<el-row>
						<el-col :span="12">
							<el-form-item  label="收货人" prop="name" >
								<el-input v-model="addInfo.receiver" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="11" class="odd_lie">
							<el-form-item  label="收货电话" prop="name" >
								<el-input v-model="addInfo.receivingPhone" ></el-input>
							</el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="12" >
							<el-form-item label="省市区:"><br>
								<el-cascader v-model="addInfo.city" :options="citys" @change="handleChange"></el-cascader> 
							</el-form-item>
						</el-col>
						<el-col :span="11" class="odd_lie">
					...
					<el-row>
						<el-col :span="12">
							<el-form-item  label="详细地址" prop="name" ><br>
								<el-date-picker  style="width:100%" v-model="addInfo.deliveryTime" type="date" placeholder="选择日期"> </el-date-picker>
							</el-form-item>
						</el-col>
						<el-col :span="11" class="odd_lie">
							<el-form-item label="资产所属组织:" >
