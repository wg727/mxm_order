...
export default {
    ...
    methods: {
        ...
        addInfoMethod() {
            ...
            // this.addInfo.list.receiver = '',
						// this.addInfo.list.receivingPhone = '',
						// this.addInfo.list.city = '',
						// this.addInfo.list.address = '',
						// this.addInfo.list.deliveryTime = '',
						// this.addInfo.list.assetsOrg = '',
						// this.addInfo.list.remark = '';
        }
    }
};
</script>
