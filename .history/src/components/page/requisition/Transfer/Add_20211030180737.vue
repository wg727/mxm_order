        ...
        <el-card id="aaa">
            ...
            <div class="productLine">
                ...
                <div class="row">
                    ...
                    <el-form :model="addTableArray">
                        <el-table :data="addTableArray.addTable" border style="width: 100%">
                            <el-table-column type="index" label="序列"></el-table-column>
                            <el-table-column prop="productName" label="产品名称" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'addTable[' + scope.$index + '].productName'">
                            ...
                            <el-table-column prop="specUnionKey" label="规格" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'addTable[' + scope.$index + '].specUnionKey'">
                            ...
                            <el-table-column prop="unitText" label="单位" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'addTable[' + scope.$index + '].unitText'">
                                        {{ scope.row.unitText }}
                                    </el-form-item>
                                </template>
                            </el-table-column>
                            <el-table-column prop="idleQuantity" label="闲置数量" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'addTable[' + scope.$index + '].idleQuantity'">
                            ...
                            <el-table-column label="申请数量" align="center">
                                <template slot-scope="scope">
                                    <el-form-item :prop="'addTable[' + scope.$index + '].applyNum'">
                                        <el-input
                                            type="number"
                                            v-model="addTableArray.addTable[scope.$index].applyNum"
                                            placeholder="请输入数量"
                                        ></el-input>
                                    </el-form-item>
                                </template>
...
export default {
        ...
        return {
            ...
            AAA: {
                aaa: [
                    ...
                    {
                        id1: 'sdSSSSSSSSSSSSSSf',
                        id2: 'dsdfsDDDDDDDDDDDDDDDf',
                        id3: ''
                    }
                ]
            }
    ...
    methods: {
        ...
        handleSelectionChange(val) {
            var newVal = this.changeKeys(val, ['productId', 'productName']);
            for (let i = 0; i < newVal.length; i++) {
                this.addInfo.applyItemList[i].productId = newVal[i].productId;
                this.addInfo.applyItemList[i].productName = newVal[i].productName;

                this.addInfo.applyItemList[i].push(this.addTableArray.applyNum[i].applyNum);
                // this.addInfo.applyItemList[i].applyNum=this.addInfo.applyNum
                // this.addInfo.applyItemList[i].idleQuantity=this.addInfo.idleQuantity
                // this.addInfo.applyItemList[i].productSpecId=this.addInfo.productSpecId
                // this.addInfo.applyItemList[i].specUnionKey=this.addInfo.specUnionKey
                // this.addInfo.applyItemList[i].auditNum=this.addInfo.auditNum
                // this.addInfo.applyItemList[i].unitText=this.addInfo.unitText
                // this.addInfo.applyItemList[i].bathEnable=this.addInfo.bathEnable
                // this.addInfo.applyItemList[i].serialNumberEnable=this.addInfo.serialNumberEnable
                // this.addInfo.applyItemList[i].outOrgId=this.addInfo.outOrgId
            }
            this.addInfo.applyItemList.push(newVal);
