    ...
    methods: {
        ...
        getTransferDetails() {
            ...
            transferApplicationDetails(params).then(res => {
							...
							this.documentDetails.remark=res.data.remark;//状态
							this.documentDetails.applyStatusText=res.data.applyStatusText;//申请备注
							this.documentDetails.auditName=res.data.auditName;//项目地址
							this.documentDetails.auditRemark=res.data.auditRemark;//计划员
							this.documentDetails.applyTypeText=res.data.applyTypeText;//审批备注
							this.documentDetails.createdDate=res.data.createdDate;//申请项目
							this.documentDetails.createdDate=res.data.lastUpdatedDate;//申请时间
							this.documentDetails.receiverAddress=res.data.receiverAddress;//最后更新
