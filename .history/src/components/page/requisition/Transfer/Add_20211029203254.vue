                    ...
                    <el-row>
                        <el-col :span="11">
                            <el-form-item label="省市区："
                                ><br />
                                <el-cascader v-model="citys" :props="optionProp"></el-cascader>
                            </el-form-item>
                        </el-col>
                        <el-col :span="11" class="odd_lie">
...
export default {
        ...
        return {
            ...
            optionProp: {
                ...
                lazyLoad(node, resolve) {
                    const id=node.level?node.data.value:1;
                    const { level } = node;
                    let nodes = [];
    ...
    methods: {
        ...
        // 提交
        addShipment() {
            this.addInfo.province = this.citys[0];
            this.addInfo.city = this.citys[1];
            this.addInfo.country = this.citys[2];
