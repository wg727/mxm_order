		...
		<el-card>
			...
			<div class="invoice_info_div">
				...
				<el-form :model="addInfo" :rules="rules" label-width="100px" class="demo-ruleForm">
					<el-col :span="12" >
							调入组织:<el-input placeholder="云镖网络科技有限公司" v-model="addInfo.transOrganiza" :disabled="true" ></el-input>
					</el-col>
					<el-col :span="12">
						<el-form-item  >
							资产所属组织<br><el-select v-model="addInfo.assetsOrg" placeholder="请选择活动区域" style="width:50%">
