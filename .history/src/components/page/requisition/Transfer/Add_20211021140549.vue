      ...
      <div class="button">
		...
		<el-card>
			...
			<el-form :model="addInfo" :rules="rules" label-width="100px" class="demo-ruleForm">
				<el-col :span="12" class="transOrganiza">
						调入组织:<br><el-input placeholder="云镖网络科技有限公司" v-model="addInfo.transOrganiza" :disabled="true" ></el-input>
				</el-col>

				<el-form-item label="资产所属组织:" ><br>
					<el-select v-model="addInfo.assetsOrg" placeholder="请选择活动区域" style="width:50%">
						<el-option label="区域一" value="shanghai" ></el-option>
						<el-option label="区域二" value="beijing"></el-option>
					</el-select>
				</el-form-item>

				<el-form-item :span="12" label="收货人" prop="name" class="transOrganiza"><br>
					<el-input v-model="addInfo.receiver" style="width:50%"></el-input>
				</el-form-item>
