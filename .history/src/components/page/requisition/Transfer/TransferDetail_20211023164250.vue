				...
				<el-tab-pane label="发货记录">
					<div>
						...
						<el-table :data="shipmentApplica" border style="margin-top:15px">
							<el-table-column prop="productName" label="产品名称"></el-table-column>
							<el-table-column prop="index" label="规格"></el-table-column>
							<el-table-column prop="applicationNum" label="单位" ></el-table-column>
							<el-table-column prop="shipNum" label="申请数量" ></el-table-column>
							<el-table-column prop="cancelNum" label="调出组织" ></el-table-column>
							<el-table-column prop="state" label="待发数量" ></el-table-column>
						</el-table>
						<!-- 分页 -->
						<el-pagination
