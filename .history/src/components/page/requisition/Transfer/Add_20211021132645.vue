      ...
      <div class="button">
		...
		<el-card>
			...
			<el-form :model="addInfo" :rules="rules" label-width="100px" class="demo-ruleForm">
				<el-col >
						调入组织:<br><el-input placeholder="云镖网络科技有限公司" v-model="addInfo.transOrganiza" :disabled="true" style="width:50%"></el-input>
				</el-col>

				<el-form-item label="资产所属组织" class="descClass"><br>
					<el-select v-model="value" placeholder="请选择活动区域" style="width:40%">
