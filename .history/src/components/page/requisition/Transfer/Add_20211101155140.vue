            ...
            <div class="addProductVisible">
                ...
                <el-row class="row">
                    ...
                    >
                        ...
                        <el-table-column prop="productList" label="产品名称"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getProducts() {
            if (this.addInfo.assetsOrgId === undefined) {
                ...
                newProductList({orgId:this.addInfo.assetsOrgId}).then(res=>{
                    ...
                    this.productList=JSON.parse(JSON.stringify(res.data).replace(/name/g, 'productList').replace(/id/g, 'productId').replace(/orgId/g, 'outOrgId')) 
                    })
        ...
        addShipment(formName) {
            ...
            // let applyItemList =this.ItemList.map(i=>{
            //     for(let key in i){
            //         if(key == 'name'){
            //             key ='productName'
            //         }else if(key == 'id'){
