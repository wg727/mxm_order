        ...
        <el-card class="el_card-style">
            <div class="detail">
                ...
                <section class="detail_section1 detail_margin">
                    <div class="section_list first">
												<span>申请人：</span>
                        <span v-if="documentDetails.auditName !=='' ">计划员：</span>
                        <span v-if="documentDetails.auditRemark !=='' ">审批备注：</span>
                        <span>申请项目：</span>
                    </div>
                    <div class="section_list">
												<span>{{documentDetails.applyUserName}}</span>
                        <span v-if="documentDetails.auditName !=='' ">{{documentDetails.auditName}}</span>
                        <span v-if="documentDetails.auditRemark !=='' ">{{documentDetails.auditRemark}}</span>
