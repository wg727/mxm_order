            ...
            <div class="invoice_info_div">
                <el-form :model="addInfo" ref="loginFormRef">
                    ...
                    <div v-for="(item, index) in addInfo.list" :key="index" class="receiver">
												<el-button size="small" plain @click="addInfoMethod" class="addInfoMethod" type="danger" round icon="el-icon-plus">追加发货信息 </el-button>
                        <el-row>
                            <el-col :span="11">
                                <el-form-item label="收货人：" prop="name">
                                    <el-input v-model="tempInfo.receiver" placeholder="请选择收货人"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="11" class="odd_lie">
                                <el-form-item label="收货电话：" prop="name">
                                    <el-input v-model="tempInfo.receivingPhone" placeholder="请输入收货电话"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
...
.receiver{
	margin-top: 20px;
	border-top: 2px solid rgb(241, 230, 230);
	padding-top: 20px;
}
.addInfoMethod{
	margin-left: 1470px;
