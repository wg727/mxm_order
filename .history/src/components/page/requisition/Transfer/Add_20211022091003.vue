      ...
      <div class="button">
		...
		<el-dialog
			...
			<div class="addProductVisible">
				...
				<el-row :gutter="10">
					<el-col :span="7">
							<el-input placeholder="请输入产品名称" @clear="getGoofsList" clearable v-model="addProductVisibleInfo.query"></el-input>
				...
				<!-- table区域 -->
				<el-row class="row">
					<el-table :data="dialogTableList" border style="width: 100%">
						<el-table-column prop="name" label="产品名称"></el-table-column>
						<el-table-column prop="applicationsNum" label="规格"></el-table-column>
						<el-table-column prop="approvalsNum" label="单位" ></el-table-column>
					</el-table>
				</el-row>
