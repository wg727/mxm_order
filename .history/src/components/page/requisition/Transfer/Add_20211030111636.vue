            ...
            <div class="productLine">
                ...
                <el-row class="row">
                    <!-- <el-table :data="addInfo.applyItemList" border style="width: 100%">
                        ...
                        <el-table-column :prop="addInfo.productName" label="产品名称"></el-table-column>
                        <el-table-column :prop="addInfo.specification" label="规格"></el-table-column>
                        <el-table-column :prop="addInfo.unit" label="单位">台</el-table-column>
                        <el-table-column :prop="addInfo.idleNum" label="闲置数量"></el-table-column>
                        <el-table-column label="申请数量">
                            <template v-slot="scoped">
                                <el-input type="number" placeholder="请输入数量" v-model="addInfo.applyNum">{{ scoped.row }}</el-input>
                            </template>
                        </el-table-column>
                    ...
                    <el-table :data="atableText" border style="width: 100%">
                        <el-table-column v-for="title in tableHeader" :key="title.code" :property="title.key" :label="title.label">
                            <template v-slot="scope">
    ...
    data() {
        return {
            ...
            tableHeader: [
                ...
                { label: '单位', key: '004' },
                { label: '申请数量', key: '005' },
                { label: '操作', key: 'ind006ex' }
            ],
            tableText: [
                {
                    productId: '111', //产品id
                    productName: '111', //产品名称
                    applyNum: 1, //申请数量
                    productSpecId: '111', //产品规格id
                    specUnionKey: '1', //产品规格
                    auditNum: 'this.addInfo.applyItemList.applyNum', //审批数量(与申请数量值相同即可)
                    unitText: '', //单位
                    bathEnable: '0', //是否启用批次管理（0否1是）
