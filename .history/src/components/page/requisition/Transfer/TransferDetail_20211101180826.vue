        ...
        <el-card class="el_card-style">
            <div class="detail">
                <section class="detail_section1 detail_margin">
                    <div class="section_list first">
                        <span>调入组织：</span>
                        <span>单据号：</span>
                        <span v-if="documentDetails.applyTypeText !== '' || null || undefined">申请项目：</span>
                        <span v-if="documentDetails.remark !== ''">申请备注：</span>
                    </div>
                    <div class="section_list">
                        <span>{{ documentDetails.inOrgName }}</span>
                        <span>{{ documentDetails.applyCode }}</span>
                        <span v-if="documentDetails.applyTypeText !== '' || null || undefined">{{ documentDetails.applyTypeText }}</span>
                ...
                <section class="detail_section1 detail_margin">
                    <div class="section_list first">
                        <span>资产所属组织：</span>
                        <span>状态：</span>
                        <span v-if="documentDetails.auditRemark !== '' || null || undefined">审批备注：</span>
                    </div>
                    <div class="section_list">
                        <span>{{ documentDetails.assetsOrgName }}</span>
                        <span>{{ documentDetails.applyStatusText }}</span>
                        <span v-if="documentDetails.auditRemark !== '' || null || undefined">{{ documentDetails.auditRemark }}</span>
                    </div>
                </section>
                ...
                <section class="detail_section1 detail_margin">``
                    <div class="section_list first">
                        ...
                        <span v-if="documentDetails.auditName !== '' || null || undefined">计划员：</span>
                        
                    </div>
                    <div class="section_list">
                        <span>{{ documentDetails.applyUserName }}</span>
                        <span v-if="documentDetails.applyType !== ''">{{ isApplyType }}</span>
                        <span  v-if="documentDetails.auditName !== '' || null || undefined">{{ documentDetails.auditName }}</span>
            ...
            <el-tabs type="border-card" style="margin-top:50px">
                ...
                <el-tab-pane label="发货记录">
                    <div>
                        <span>| 待发货</span>
                        <el-table :data="document" border style="margin-top:15px">
                            <el-table-column prop="productName" label="产品名称"></el-table-column>
                            <el-table-column prop="specification" label="规格"></el-table-column>
                            <el-table-column prop="unitText" label="单位"></el-table-column>
                            <el-table-column prop="applyNum" label="申请数量"></el-table-column>
                            <el-table-column prop="outOrgName" label="调出组织"></el-table-column>
                            <el-table-column prop="waitNum" label="待发数量"></el-table-column>
                        </el-table>
                        <!-- 分页 -->
                        <el-pagination
