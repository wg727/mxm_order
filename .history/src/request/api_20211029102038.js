...
export const flowChart = p => post('https://office.yunbiaokj.com:3105/uc/user/v6/login',p);
// TransferDetail-新增调拨单--资产所属组织
// export const flowChart = p => post('neworder/api/v1/allocate/getAssetsOrgList',p);
