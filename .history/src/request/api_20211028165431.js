...
export const cancelTransferRequisition = p => post('neworder/api/v1/allocate/detail',p);
// TransferDetail-调拨单详情的发货记录
export const detailDeliveryRecord = p => post('neworder/api/v1/allocate/detail',p);
// TransferDetail-查询发货撤回记录列表
export const shipmentWithdrawalRecordlist = p => post('neworder/api/v1/allocate/detail',p);
