        ...
        <el-card>
            ...
            <div class="a">
                ...
                <el-row :gutter="20" class="orderMessage">
                    ...
                    <el-col :span="12" class="colPadding">
                        订单类型:<br /><el-select v-model="value" placeholder="请选择订单类型">
                            <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"> </el-option>
                        </el-select>
                    </el-col>
                    <el-col :span="12" class="colPadding">
                        合同编号:<el-input placeholder="请输入合同编号" v-model="addSalesOrderInfo.sealCompany"></el-input>
                    </el-col>
                    <el-col :span="12" class="colPadding">
                    ...
                    <el-col :span="12" class="colPadding">
                        合同签约公司:<br /><el-select v-model="value" placeholder="">
                            <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"> </el-option>
                        </el-select>
                    </el-col>
                    <el-col :span="12" class="colPadding">
            ...
            <div class="a">
                ...
                <el-row :gutter="20" class="orderMessage">
                    ...
                    <el-col :span="12" class="colPadding">
                        ...
                        <div>
                            省市区:<el-cascader
                                v-model="addSalesOrderInfo.city"
                                :options="citys"
                                @change="handleChange"
                                placeholder="请选择省市区"
                            ></el-cascader>
            ...
            <div class="productLine">
                ...
                <el-row class="row">
                    <el-table :data="productLine" border style="width: 100%">
                        ...
                        <el-table-column prop="contractProductName" label="单位"></el-table-column>
                        <el-table-column prop="productName" label="押金(个/元)"></el-table-column>
                        <el-table-column prop="productName" label="押金(元/天)"></el-table-column>
                        <el-table-column prop="specification" label="租期"></el-table-column>
                        <el-table-column prop="specification" label="租赁天数"></el-table-column>
                        <el-table-column prop="bunbers" label="数量"></el-table-column>
                        <el-table-column prop="bunbers" label="总额(元)"></el-table-column>
                        <el-table-column prop="bunbers" label="操作"></el-table-column>
                    </el-table>
                </el-row>
                <div class="a">
                    <el-row :gutter="20" class="orderMessage">
