    ...
    <span class="title">采购退换货</span>
      ...
      <el-row class="orderlist"> 
					<el-table :data="allOrderList" border >
						...
						<el-table-column prop="orderTime" label="退货申请编号"></el-table-column>
						
						<el-table-column  prop="id" label="退货编号">
						...
						<el-table-column prop="area" label="申请时间" ></el-table-column>
						<el-table-column prop="orderAmount" label="申请人" ></el-table-column>
						<el-table-column prop="sentNum" label="供应商" ></el-table-column>
						<el-table-column prop="sentedNum" label="	类型" ></el-table-column>
